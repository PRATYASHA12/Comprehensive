...
public class SeleniumComprehensive1 {

	public static void main(String[] args) throws InterruptedException {
		// TODO Auto-generated method stub
		System.setProperty("webdriver.gecko.driver", "E:\\gekoDriver\\geckodriver.exe");
		...
		driver.findElement(By.id("guest_name")).sendKeys("Pratyasha");
		driver.findElement(By.xpath("//*[@id=\"guest-form\"]/div/div[2]/div/div/input")).sendKeys("8240346320");
		driver.findElement(By.xpath("//*[@id=\"guest_email\"]")).sendKeys("mitrapratyasha13@gmail.com");
